      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Барномаро ман, Амиров А, таҳия намудам. Ҳадафи ман, таъмин кардани маводҳои таълимӣ ва осорҳои кӯмакрасон барои омӯзгорон ва донишҷӯён мебошад. Агар шумо саволҳо ё пешниҳодҳо дошта бошед, лутфан бо ман тавассути почта ё дигар воситаҳо иртибот кунед.',
              style: TextStyle(
                fontSize: 16,
                color: Colors.black87,
                height: 1.5,
